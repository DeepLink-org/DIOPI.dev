...
'plus_scalar_inp' : dict(
    ...
    'embedding_lookup_pos_encoding' : dict(
        name=['embedding_lookup_pos_encoding'],
        interface=['CustomizedTest'],
        para=dict(
            batch_size = [3],
            hidden_units = [10],
        ...
        tensor_para=dict(
            args=[
                {
                    "ins": ['from_tensor'],                 # [batch_size, hidden]
                    "shape": ((3, 10), ),      
                    "dtype": [np.float32, np.float16],
                    "gen_fn": 'Genfunc.randn',
                },
                ...
                {
                    "ins": ['all_ids'],                      # [sessionlen(step + 1), batch_size]
                    "shape": ((3, 3), ),
                    "dtype": [np.int32],
                    "gen_fn": dict(fn='Genfunc.randint', low=0, high=4),
                }
    ...
    'fused_context_attention_inp' : dict(
        ...
        tensor_para=dict(
            args=[
                {
                    "ins": ['inoutput'],
                    "shape": ((15, 30), (15, 12)),               # [token_num, hidden(size_per_head * head_num)]
                    "dtype": [np.float32, np.float16],
                    "gen_fn": 'Genfunc.randn',
                },
                {
    ...
    'fused_silu_ffn_inp' : dict(
        ...
        tensor_para=dict(
            args=[
                {
                    "ins": ['inoutput'],                 # [token_num, hidden_units]
                    "shape": ((10, 100),),      
                    "dtype": [np.float32, np.float16],
                    "gen_fn": 'Genfunc.randn',
                },
                {
                    "ins": ['weight1'],                  # [hidden_units, inter_size]
                    "shape": ((100, 200),),
                    "dtype": [np.float32, np.float16],
                    "gen_fn": 'Genfunc.randn',
                },
                {
                    "ins": ['weight2'],                  # [inter_size, hidden_units]
                    "shape": ((200, 100),),
                    "dtype": [np.float32, np.float16],
                    "gen_fn": 'Genfunc.randn',
                },
                {
                    "ins": ['weight3'],                 # [hidden_units, inter_size]
                    "shape": ((100, 200),),
                    "dtype": [np.float32, np.float16],
                    "gen_fn": 'Genfunc.randn',
                }
