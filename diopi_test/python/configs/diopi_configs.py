...
diopi_configs = {
    ...
    'pointwise_op_bool': dict(
        ...
        name=[ 'cos', 'erf', 'exp', 'sin', 'asin', 'sqrt', 'rsqrt', 'atan', 'logical_not'],
        interface=['torch'],
        dtype=[np.bool_],
        tensor_para=dict(
            gen_fn='Genfunc.mask',
    ...
    'sign': dict(
        name=['sign'],
        interface=['torch'],
        dtype=[  np.float32, np.float64, np.int16,
            ...
            args=[
                {
                    "ins": ['input'],
                    "shape": ((), (12,), (2, 2), (12, 22)),
                    "dtype": [np.float64, np.float32,   np.int64, np.int32, np.int16, np.int8, np.bool_,
                ...
                },
                {
                    ...
                    "shape": ((), (12,), (2, 2), (12, 21)),
                    "dtype": [np.float64, np.float32,   np.int64, np.int32, np.int16, np.int8, np.bool_,
                              np.bool_, np.int8, np.int16, np.int32, np.int64,   np.float32, np.float64,]
                }
            ]
        ),
    ),
            ...
            args=[
                {
                    ...
                    "shape": ((), (64, ), (169, 4), (17100, 2), (1, 1, 384),
                              (4, 133, 128, 128), (2, 64, 3, 3, 3),
                              (0,), (12, 0), (2, 0, 12)),
                    "dtype": [np.bool_,   np.float32, np.float64,
            ...
            args=[
                ...
                },
                {
                    ...
                    "dtype": [np.int32, np.bool_, np.uint8, np.float32,
                                np.int64, np.int8, np.uint8, np.float64],
                    "gen_fn": 'Genfunc.ones'
                },
            ],
        ),
            ...
            args=[
                {
                    ...
                    "shape": ((), (1,), (1024, 80), (2, 256, 256), (2, 1, 64, 64),
                              (12, 0), (2, 0, 9), (0, 9, 8, 7)),
                    "dtype": [np.float64,   np.float32, np.int32, np.int16,
            ...
            args=[
                {
                    ...
                    "shape": ((), (1, ), (16,), (8, 48), (4, 128, 128), (256, 8, 8),
                              (0,), (7, 0), (9, 0, 6)),
                    "dtype": [np.float32, np.float64,   np.bool_,
    ...
    'permute': dict(
        ...
        interface=['torch'],
        para=dict(
            dims=[(), (0, 1, 3, 2, 4, 5), (0, 2, 3, -3), (1, 0), (0, -2, -1), (0,), (-1,)],
        ),
        tensor_para=dict(
            args=[
                {
                    "ins": ['input'],
                    "shape": [(), (2, 8, 7, 8, 7, 128), (2, 3, 200, 304), (20267, 1), (2, 3, 4), (0,), (1,)],
                    "gen_fn": 'Genfunc.randn',
                    "dtype": [np.float32, np.float64,   np.int16,
                              np.int32, np.int64, np.uint8, np.int8, np.bool_],
                },
            ...
            args=[
                {
                    ...
                    "shape": ((), (252,), (2, 256), (4, 64, 128), (4, 2, 12, 3),
                              (0,), (2, 0), (7, 0, 9)),
                    "dtype": [np.int64, np.float32, np.float64,   np.int16,
    ...
    'prod': dict(
        ...
        tensor_para=dict(
            args=[
                {
                    "ins": ['input'],
                    "shape": ((), (42,), (70, 1, 2), (2, 512, 38, 38), (2, 80, 128, 128, 1),
                              (0,), (3, 0), (2, 0, 6)),
                    "dtype": [np.float32, np.float64,   np.int16, np.int32,
                              np.int64, np.uint8, np.int8, np.bool_],
                    "gen_fn": 'Genfunc.randn',
            ...
            args=[
                {
                    ...
                    "dtype": [np.float32, np.float64,   np.int32,
                              np.int64, np.uint8, np.int8, np.bool_],
                },
                {
                    "ins": ['indices1'],
            ...
            args=[
                {
                    ...
                    "dtype": [np.float32, np.float32, np.float64,
                              np.float32, np.int64, np.uint8, np.int16,
                              np.int32, np.int64, np.uint8, np.uint8, np.int8,
                              np.uint8, np.int32, np.uint8, np.bool_,
                ...
                },
                {
                    ...
                    "dtype": [np.float64, np.int64, np.int32,
                              np.complex128, np.float32, np.float64, np.uint8,
                              np.int64, np.int32, np.int16, np.int8, np.uint8,
                              np.bool_, np.complex128, np.complex128, np.uint8,
            ...
            args=[
                {
                    ...
                    "dtype": [np.float64, np.float32, np.float64,
                              np.float64, np.float64, np.float32, np.int16,
                ...
                },
                {
                    ...
                    "dtype": [ np.float64, np.int32, np.int16,
                              np.int8, np.bool_, np.complex64, np.float64,
        ...
        tensor_para=dict(
            ...
            args=[
                ...
                },
                {
                    ...
                    "dtype": [ np.float32, np.int16, np.int8,
                              np.uint8, np.bool_, np.complex128, np.float32,
                              np.float64,  np.float32, np.int32, np.int16,
        ...
        tensor_para=dict(
            ...
            args=[
                ...
                },
                {
                    ...
                    "shape": ((2, 16, 16, 2),),
                    "stride": ((512, 16, 1, 256),),
                    "dtype": [  np.float32,   np.float32, np.int64],
                },
            ]
        )
    ),
            ...
            args=[
                {
                    ...
                    "dtype": [ np.float64, 
                              ...
                              np.int8, np.bool_, np.bool_, np.bool_,
                              np.bool_, np.complex128, np.complex64, np.complex64,
                ...
                },
                {
                    ...
                    "dtype": [ np.float32,
                              np.uint8, np.int64,  np.complex64,
                              ...
                              np.complex64,  np.int16, np.int8, np.bool_,
                              np.complex64,  np.float32, np.int16, np.int8,
    ...
    'isnan': dict(
        name=['isnan'],
        interface=['torch'],
        dtype=[np.float64, np.float32,   np.int16, np.int32, np.int64, np.int8, np.uint8, np.bool_],
        tensor_para=dict(
            gen_fn='Genfunc.randn',
            args=[
                {
